...
func TestGetSmoothNumbers(t *testing.T) {
	...
	t.Run("Input98ShouldGetHumbleNumbers", func(t *testing.T) {
		expected := "humble numbers"
		result := GetSmoothNumber(98)
	...
	t.Run("Input111ShouldGetNonSmooth", func(t *testing.T) {
		expected := "non-smooth"
		result := GetSmoothNumber(111)
